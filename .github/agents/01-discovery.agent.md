...
- Keep momentum: avoid long monologues and drive short iteration cycles
...
Work through these steps with the user. Do not rush.
...
- What is the cost of the status quo? (quantify)
- Why now?
...
- What is likely to change? What external factors could shift requirements?
...
- [ ] Remaining unknowns explicitly listed with next validation step
...
When all items pass, output exactly: Gate 1 passed. Ready for Phase 2: Product Definition.
