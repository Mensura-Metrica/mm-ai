...
- Create/update items in the issue tracker for project-plan workstreams, risk mitigations, and sequencing decisions.
- Keep item states synchronized with plan artifacts and Gate 4 evidence.
